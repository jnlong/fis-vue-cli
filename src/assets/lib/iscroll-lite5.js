/**
 * @file: iscroll-lite5.js
 * @author Matteo Spinelli ~ http://cubiq.org/license
 * ver: iScroll v5.2.0
 * update: 2016/07/27
 */
...
(function (window, document, Math) {
  ...
  */
    ...
    IScroll.prototype = {
        ...
        // 滚动，让某个元素居中
        scrollToElementMid: function(el, time) {
            var that = this,
                curW;

            el = el.nodeType ? el : that.scroller.querySelector(el);
            if (!el) return;
            curW = el.clientWidth || that.wrapperW;

            that.scrollToElement(el, time, (that.wrapperW - curW)/2);
        },
